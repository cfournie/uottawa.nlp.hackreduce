...
2. Do not redistribute the NRC Emotion Lexicon. Please refer
interested parties to Saif Mohammad (saif.mohammad@nrc-cnrc.gc.ca).
...
VERSION INFORMATION
-------------------
Version 0.5 has annotations for roughly half of the words in version
0.91 (the latest version as of 6 July 2011). These are the most
frequent terms among those in version 0.91. Please contact NRC if
interested in the larger lexicon.
